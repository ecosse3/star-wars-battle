...
export const mockPeople1: IPeople = {
...
export const mockPeople2: IPeople = {
  name: 'Wilhuff Tarkin',
  height: '180',
  mass: 'unknown',
  ...
  films: ['https://swapi.py4e.com/api/films/1/', 'https://swapi.py4e.com/api/films/6/'],
  species: ['https://swapi.py4e.com/api/species/1/'],
  vehicles: [],
  starships: [],
...
export const mockPeople3: IPeople = {
  name: 'Chewbacca',
  height: '228',
  mass: '112',
  hair_color: 'brown',
...
export const mockPeople4: IPeople = {
  ...
  species: ['https://swapi.py4e.com/api/species/5/'],
  vehicles: [],
  starships: [],
...
export const mockPeople5: IPeople = {
  name: 'Wedge Antilles',
  height: '170',
  mass: '84',
  hair_color: 'brown',
